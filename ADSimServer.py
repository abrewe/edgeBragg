...
# modified version of ADSimServer by
...
def main():
    ...
    parser.add_argument('--channel-name', '-cn', type=str, dest='channel_name', default='pvapy:image:test', help='Server PVA channel name (default: pvapy:image)')
